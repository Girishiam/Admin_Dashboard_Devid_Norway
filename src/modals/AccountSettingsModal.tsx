    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black bg-opacity-50 backdrop-blur-sm">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          {/* Image */}
          <div>
            <label className="block text-sm font-semibold text-gray-900 mb-2">Profile Image</label>
            <div className="flex gap-3">
              <input
                ...
                className="flex-1 px-4 py-3 border border-gray-300 rounded-lg bg-gray-50 text-sm text-gray-500"
              />
              <label 
                className="px-6 py-3 text-white rounded-lg cursor-pointer hover:opacity-90 transition-all flex items-center gap-2"
